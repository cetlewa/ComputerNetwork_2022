...
OPEN報文：用來與相鄰的另一個BGP發言人建立關係

UPDATE報文：用來發送某一路由的信息，以及列出要撤銷的多條路由

KEEPLIVE報文：用來確認打開報文和週期性證實鄰站關係

NOTIFICATION報文：用來發送檢測到的差錯

## 路由器

具有多個輸入/輸出端口的專用計算機，任務是轉發分組

組成：路由選擇部分、分組轉發部分

決定報文轉發速率的因素：輸入、輸出端口的處理性能，交換機構的性能

衡量路由器的性能指標：pps（packet per second）

![截圖 2022-04-06 08.16.42](./chp4_image/截圖 2022-04-06 08.16.42.png)

![截圖 2022-04-06 08.17.34](./chp4_image/截圖 2022-04-06 08.17.34.png)

## 組播

组播(multicast)又称为多播，用于实现一点对多点的数据传输。对于一些网络应用，采用组播可大大减少网络流量

![截圖 2022-04-06 08.42.48](./chp4_image/截圖 2022-04-06 08.42.48.png)
...
![截圖 2022-04-06 09.08.15](./chp4_image/截圖 2022-04-06 09.08.15.png)

### 虛擬專用VPN

多个企业/机构的内部网络之间互连的实现方法：租用专用线路，形成专用网，成本高昂

基于公用网络(如Internet)，形成VPN，涉及的技术包括：隧道(tunnel)、加密、身份认证等

![截圖 2022-04-06 09.18.40](./chp4_image/截圖 2022-04-06 09.18.40.png)
